    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
        ...
        <p className="text-lg lg:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed drop-shadow animate-fade-in-delay">
          Take the first step toward clearer vision. Fill out the form below and we’ll confirm your appointment within <span className="font-semibold">24 hours</span>.
        </p>
      </div>
